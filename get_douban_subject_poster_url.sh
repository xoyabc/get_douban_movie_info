...
do
    ...
    # dou list
    curl -s "https://www.douban.com/doulist/${doulist_id}/?start=${i}&sort=seq&playable=0&sub_type=" -A 'Mozilla/5.0 (Windows NT 6.1; Win64; x64)' |pup 'div[class="post"] a img attr{src}' >> douban_subjects
    sleep 1
done
